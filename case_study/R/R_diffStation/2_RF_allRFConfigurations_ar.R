...
benchmark <- T    # whether to use only lagged driving variables as predictors in the random forests 
source('function_0_loadLibrary.R')
source('self-explanatory/function_2_RF_0_setUpDirectory_ar.R')
...
for(station_i in seq_along(station)){
    source(paste0('self-explanatory/function_1_readData_excludeChannelStorage_benchmarkModel_ar.R'))
